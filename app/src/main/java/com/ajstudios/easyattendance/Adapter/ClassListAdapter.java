...
public class ClassListAdapter extends RecyclerView.Adapter<ClassListAdapter.ClassesViewHolder> {

    private final Activity mActivity;
    private final List<Classes> mList;

    public ClassListAdapter(List<Classes> list, Activity context) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ClassListAdapter.ClassesViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mActivity, ClassDetail_Activity.class);
